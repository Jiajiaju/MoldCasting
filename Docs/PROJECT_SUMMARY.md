...
- **动作手感**：输入响应、移动惯性、攻击反馈、受击硬直、镜头与震动共同塑造扎实手感。
- **一镜到底**：全流程绝不切镜，通过连续的镜头调度、无缝过场和流式加载保持完整、连续的体验；场景遮挡也不得用于隐藏切镜。
- **动作表演精细度**：提升动画衔接、姿态控制、脚步贴合、交互动画、表情与演出细节。
- **完整环境交互**：构建可靠的碰撞、物理反馈、可破坏物、碎片、声音、特效及持续状态。
